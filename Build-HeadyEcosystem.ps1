...
function Move-ApplicationFiles {
    ...
    $appFiles = @(
        ...
        @{ Source = "package-lock.json"; Desc = "Node.js lock file" },
        @{ Source = "tsconfig.json"; Desc = "TypeScript config" },
        @{ Source = "webpack.config.js"; Desc = "Webpack config" },
        @{ Source = "vite.config.js"; Desc = "Vite config" },
